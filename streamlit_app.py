...
st.markdown("Otimize sua revisão de conteúdo com os resumos gerados pelo Google Gemini. Analise rapidamente seus textos, artigos, anotações físicas e digitais para ter mais clareza e eficiência.")
